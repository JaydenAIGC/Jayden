...
class Backend:
    ...
    def gen_subject_ideas(self,style_name=""):
        try:
            ...
            ctx=f"【风格关键词】{kw}\n【风格氛围】{mood}\n【核心材质】{mat}"
            prompt=f"""你是巨构场景创意生成助手。当前风格「{style_name}」，风格特征如下：
{ctx}
...
合格示例：
{{"subject":"茫茫冰原深处，冰封已久的巨型环形石质堡垒静静矗立峡谷","target_style":"{style_name}"}}"""
            h=self._headers("llm")
...
- 视角变化：远景全景、中景压缩感、仰视压迫感、侧翼视角、俯瞰视角
