...
.header h1{font-size:18px;font-weight:700;background:linear-gradient(135deg,#a29bfe,#6c5ce7 30%,#00cec9 70%,#55efc4);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;flex-shrink:0;display:flex;align-items:baseline;gap:4px}
...
<body>
<div class="header">
 <h1>街灯AI <span style="font-size:13px;font-weight:600">JAYDEN AI</span></h1>
