...
class Backend:
    ...
    def gen_subject_ideas(self):
        try:
            ...
            _land=_idea_r.choice(["冰原","沙漠","云海","荒原","海岸悬崖","火山口","深海裂谷","城市废墟","地下空洞","盐碱地","冻土苔原","干涸河床","广袤草原","起伏丘陵","茂密森林","开阔旷野"])
...
只输出JSON数组，不要多余文字"""}],
    ...
    def build_prompt(self,desc,comp=False,light=False,human=True,size="1024x1792"):
        ...
        if is_natural:
            ...
            style_tag="影视环境概念原画，Octane渲染，写实物理渲染，极简巨型几何构造，依靠嵌套、悬挑、高低层级塑造层次感，低纹理密度，哑光平滑材质，剔除繁杂细碎雕刻、密集零件，单一柔和漫射天光，低饱和度统一色调，画面大面积留白，强烈人与巨构尺度反差，空灵孤寂辽阔氛围，轮廓干净利落，8K超清"
        # ③ 核心主体 从 desc 来
        # ④ 场景自适应环境
